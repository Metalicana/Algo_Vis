...
bool isSortedDown(int gArray[25])
{
  int i;
  for(i=0;i<24;i++)
  {
    if(gArray[i]>gArray[i+1]) return false;
  }
  return true;
}
bool isSortedUp(int gArray[25])
{
  int i;
  for(i=0;i<24;i++)
  {
...
SDL_Texture* loadTextTexture(string textureText,SDL_Color textColor)
{
    ...
    SDL_Surface* textSurface = TTF_RenderText_Blended(chotofont, textureText.c_str(), textColor);
...
void stringToArray(std::string inputString);
Ltexture  header_text_input_texture;
void NumberInputFromUser(){
  ...
  while( !quit_this )
  {
    ...
    header_text_input_texture.renderText(50,300 );
...
bool loadMedia()
{
    numberInputTexture = loadTexture("Enter Numbers.png");
    bool s = true;
    ...
    chotofont = TTF_OpenFont("Fonts/Raleway-Light.ttf",10);
    return s;
...
void stringToArray(std::string inputString){
  char temp[1000];
  int i, len = inputString.size();
  for( i=0; i < len; i++){
    temp[i] = inputString[i];
  }
  temp[i] = 0;
  sscanf(temp, "%d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d", &gArray[0], &gArray[1], &gArray[2], &gArray[3], &gArray[4], &gArray[5], &gArray[6], &gArray[7], &gArray[8], &gArray[9], &gArray[10], &gArray[11], &gArray[12], &gArray[13], &gArray[14], &gArray[15], &gArray[16], &gArray[17], &gArray[18], &gArray[19], &gArray[20], &gArray[21], &gArray[22], &gArray[23], &gArray[24] );
...
int main()
{
  ...
  stringToArray(numbers);  bool file_input_bd = false;
    bool user_input_ia = false;
    bool user_input_id = false;
    bool user_input_ba = false;
    bool user_input_bd = false;
    bool user_input_taken_ba = false;
    bool user_input_taken_bd = false;
    bool user_input_taken_ia = false;
    bool user_input_taken_id = false;
    ...
    while(!quit)
    {
        while(SDL_PollEvent(&e))
        {
            ...
            else if(e.type == SDL_MOUSEBUTTONDOWN)
            {
                ...
                else if(hover(bubble_button_x,bubble_button_y,bubble_button_width,bubble_button_height,mx,my)&&!list_menu && menu)
                {
                  ...
                  file_input_taken_ba = false;
                  file_input_taken_bd = false;
                ...
                else if(hover(insertion_button_x,insertion_button_y,insertion_button_width,insertion_button_height,mx,my)&&!list_menu && menu)
                {
                    ...
                    file_input_taken_ia = false;
                    file_input_taken_id = false;

                    //cout << insertion_menu<< '\n';
                }
                else if(hover(insertion_descending_button_x,insertion_descending_button_y,insertion_descending_button_width,insertion_descending_button_height,mx,my) && list_menu && menu && insertion_ascending_menu &&insertion_descending_menu &&!bubble_ascending_menu &&!bubble_descending_menu)
                {
                //  insertion_menu = true;
                    insertion_descending_menu = false;
                    insertion_ascending_menu = true;
                }
                else if(hover(insertion_ascending_button_x,insertion_ascending_button_y,insertion_ascending_button_width,insertion_ascending_button_height,mx,my)&& list_menu && menu &&insertion_ascending_menu && insertion_descending_menu &&!bubble_ascending_menu &&!bubble_descending_menu)
                {
                    //insertion_menu = true;
                ...
                else if(hover(bubble_descending_button_x,bubble_descending_button_y,bubble_descending_button_width,bubble_descending_button_height,mx,my) && list_menu && menu && bubble_ascending_menu &&bubble_descending_menu)
                {
                //  bubble_menu = true;
                    bubble_descending_menu = false;
                    bubble_ascending_menu = true;
              ...
              else if(hover(file_input_button_x,file_input_button_y,file_input_button_width,file_input_button_height,mx,my) && insertion_ascending_menu && insertion_descending_menu && bubble_descending_menu)
                {
                  file_input_ba = true;

                }
                else if(hover(file_input_button_x,file_input_button_y,file_input_button_width,file_input_button_height,mx,my) && insertion_ascending_menu && insertion_descending_menu &&bubble_ascending_menu)
                {
                  file_input_bd = true;
        ...
        //if(state[SDL_SCANCODE_K]) NumberInputFromUser();
        if(!menu)
        {
            SDL_SetRenderDrawColor( main_renderer, 0xFF, 0xFF, 0xFF, 0xFF );
            SDL_RenderClear( main_renderer );
            ...
            else
            {
                ...
                else if(!bubble_menu)
                {
                  ...
                  if(!bubble_ascending_menu)
                  {
                    ...
                    if(!user_input_ba && !file_input_ba){
                    ...
                    SDL_RenderPresent(main_renderer);
                      ...
                      if(file_input_ba){
                        if(!user_input_taken_ba){
                        NumberInputFromUser();
                        stringToArray(numbers);
                        user_input_taken_ba = true;}
                        SDL_SetRenderDrawColor( main_renderer,0xDD, 0xAD,  0x02 , 0xFF );
                        SDL_RenderClear(main_renderer);
                      for(w=0;w<24;)
                      {
                        bubble_ascending_load_button.render(bubble_ascending_load_x,bubble_ascending_load_y,&bubble_ascending_load_button_rect);
                          while(SDL_PollEvent(&s))
                          {
                              if(s.type==SDL_KEYDOWN)
                              {
                                  ...
                                  {
                                    bubble_ascending_load_button.render(bubble_ascending_load_x,bubble_ascending_load_y,&bubble_ascending_load_button_rect);
                                      if(gArray[w]>gArray[w+1])
                                      {
                                          swap(gArray[w],gArray[w+1]);
                                          temp1 = w;
                                          temp2 = w+1;
                                      }
                                      // printf("Okay\n");
                                      for(j = w;j<w+1;j++)
                                      {
                                          ...
                                          for(q=0;q<25;q++)
                                          {
                                              ...
                                              aras[q] ={250 + q*20,450-gArray[q]*15,15,gArray[q]*15};
                                              char tempStr[20];
                                              sprintf(tempStr,"%d",gArray[q]);
                                              tempTexture.loadFromRenderedText(tempStr, textColor);
                                              tempTexture.renderText(250 + q*20,  gArray[q]*15+(475-gArray[q]*15));
                                              if(q==temp2){
                                               SDL_SetRenderDrawColor( main_renderer,0x00, 0x00,  0x00 , 0xFF );
                                              ...
                                              else if((q!=temp1)&&(q!=temp2)){SDL_SetRenderDrawColor( main_renderer,0xDD, 0xDD,  0xDD , 0xFF );
                                                SDL_RenderFillRect( main_renderer, &aras[q] );}
...
///// repeeeeeeeeeeeeeat
                      ...
                      else  if(!bubble_descending_menu)
                      {
                        ...
                        if(!user_input_bd && !file_input_bd){
                        ...
                        SDL_RenderPresent(main_renderer);
                          ...
                          if(file_input_bd){
                            if(!user_input_taken_bd){
                            NumberInputFromUser();
                            stringToArray(numbers);
                            user_input_taken_bd = true;
                          }
                            SDL_SetRenderDrawColor( main_renderer,0xDD, 0xAD,  0x02 , 0xFF );
                            SDL_RenderClear(main_renderer);
                          for(w=0;w<24;)
                    ...
                    else if(!insertion_menu)
                    {
                        SDL_SetRenderDrawColor( main_renderer,0xDD, 0xAD,  0x02 , 0xFF );
                        SDL_RenderClear(main_renderer);
                        if(insertion_ascending_menu && insertion_descending_menu){
                        ...
                        if(!insertion_ascending_menu)
                        {
                          ...
                          if(file_input_ia)
                            {
                              if(!user_input_taken_ia){
                              NumberInputFromUser();
                              stringToArray(numbers);
                              user_input_taken_ia = true;}
                              SDL_SetRenderDrawColor( main_renderer,0xDD, 0xAD,  0x02 , 0xFF );
                              SDL_RenderClear(main_renderer);
                              for(w=0;w<25;)
                              {
                        ...
                        else if (user_input_ia)
                        {
                          if(!file_input_taken_ia)
                          {
                            fp1 = fopen("in.txt","r");
                            for(x = 0;x<25;x++)
                            {
...
//                                      printf("q = %d\n",q);
                        ...
                        else if(!insertion_descending_menu)
                        {
                          ...
                          if(file_input_id)
                          {if(!user_input_taken_id){
                            NumberInputFromUser();
                            stringToArray(numbers);
                            user_input_taken_id = true;}
                            SDL_SetRenderDrawColor( main_renderer,0xDD, 0xAD,  0x02 , 0xFF );
                            SDL_RenderClear(main_renderer);
                            for(w=0;w<25;)
                            {
                        ...
                        else if (user_input_id)
                        {
                          if(!file_input_taken_id)
                          {
                            fp1 = fopen("in.txt","r");
                            for(x = 0;x<25;x++)
                            {
