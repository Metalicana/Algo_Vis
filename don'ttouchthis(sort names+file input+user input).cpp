...
bool isSortedDown(int mononerGlobalArray[25])
{
  int i;
  for(i=0;i<24;i++)
  {
    if(mononerGlobalArray[i]>mononerGlobalArray[i+1]) return false;
  }
  return true;
}
bool isSortedUp(int mononerGlobalArray[25])
{
  int i;
  for(i=0;i<24;i++)
  {
...
void stringToArray(std::string inputString){
  ...
  temp[i] = 0;
  sscanf(temp, "%d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d", &mononerGlobalArray[0], &mononerGlobalArray[1], &mononerGlobalArray[2], &mononerGlobalArray[3], &mononerGlobalArray[4], &mononerGlobalArray[5], &mononerGlobalArray[6], &mononerGlobalArray[7], &mononerGlobalArray[8], &mononerGlobalArray[9], &mononerGlobalArray[10], &mononerGlobalArray[11], &mononerGlobalArray[12], &mononerGlobalArray[13], &mononerGlobalArray[14], &mononerGlobalArray[15], &mononerGlobalArray[16], &mononerGlobalArray[17], &mononerGlobalArray[18], &mononerGlobalArray[19], &mononerGlobalArray[20], &mononerGlobalArray[21], &mononerGlobalArray[22], &mononerGlobalArray[23], &mononerGlobalArray[24] );
                    ...
                    SDL_RenderPresent(main_renderer);
                      ...
                      for(w=0;w<24;)
                      {
                        bubble_ascending_load_button.render(bubble_ascending_load_x,bubble_ascending_load_y,&bubble_ascending_load_button_rect);
                          while(SDL_PollEvent(&s))
                          {
                              if(s.type==SDL_KEYDOWN)
                              {
                                  ...
                                  {
                                      if(mononerGlobalArray[w]>mononerGlobalArray[w+1])
                                      {
                                          swap(mononerGlobalArray[w],mononerGlobalArray[w+1]);
                                          //printf("%d %d\n",w,w+1);
                                      }
                                      // printf("Okay\n");
                                      for(j = w;j<w+1;j++)
                                      {
                                          ...
                                          for(q=0;q<25;q++)
                                          {
                                              ...
                                              aras[q] ={250 + q*20,450-mononerGlobalArray[q]*15,15,mononerGlobalArray[q]*15};
                        ...
                        if(!file_input_taken_ba)
                        {
                          ...
                          for(x = 0;x<25;x++)
                          {
                            fscanf(fp1, "%d", &mononerGlobalArray[x]);
                          }
                          if(x==25)
                          {
                            fclose(fp1);
                          ...
                          bubble_ascending_load_button.render(bubble_ascending_load_x,bubble_ascending_load_y,&bubble_ascending_load_button_rect);
                            ...
                            if(!paused){
                                ...
                                if(ialc==25*25*25)
                                {
                                  ...
                                  for(x=0;x<25;x++)
                                  {
                                    fprintf(fp2, "%d ", mononerGlobalArray[x]);
                                  }
                                  if(x==25)
                                  {
                                    fclose(fp2);
                                ...
                                //insertion_ascending_load_button.render(insertion_ascending_load_x,insertion_ascending_load_y,&insertion_ascending_load_button_rect);
                                  ...
                                  while(SDL_PollEvent(&s))
                                  {
                                      if(s.type==SDL_KEYDOWN)
                                      {
                                          ...
                                          {
                                              int j = w;
                                              while(j >= 1 && mononerGlobalArray[j] <= mononerGlobalArray[j-1])
                                              {
                                                  swap(mononerGlobalArray[j],mononerGlobalArray[j-1]);
                                                  if(s.type==SDL_KEYDOWN)
                                                  {
                                  ...
                                  j = w;
                                  if(!paused){
                                    if(isSortedDown(mononerGlobalArray))
                                    {
                          ...
                          if(!file_input_taken_id)
                          {
                            ...
                            for(w=0;w<25;)
                            {
                              //insertion_ascending_load_button.render(insertion_ascending_load_x,insertion_ascending_load_y,&insertion_ascending_load_button_rect);
                                ...
                                j = w;
                                if(!paused){
                                  if(isSortedUp(mononerGlobalArray))
                                  {
